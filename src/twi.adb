...
package body TWI is
    ...
    function TWI_Get_FIFO_Depth return Integer is
        Depth_Log2 : constant Natural :=
           Natural (TWI_Periph.CTRL.TWI_CTRL_FIFO);
    begin
    ...
    function TWI_Sense_SCL return Boolean is
        --Make subtype of boolean for high/low
    begin
    ...
    function TWI_Transfer
       (Data : in out Integer; Ack_Next : in Boolean) return Integer is
    begin
    ...
    begin
        ...
        for I in 0 .. 127 loop
            ...
            TWI_Generate_Stop;
            -- [Write Address] Poke Write Address
